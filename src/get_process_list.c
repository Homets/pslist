...
BOOL GetProcessInfo()
{
	...
	_tprintf( TEXT("PID\tPPID \tPRI\tTHD\tHDN\tMemory Size\tCreationTime\t\tName\n"));
	...
	{	
		...
		if (error_access)
		{
			_tprintf( TEXT("%ld\t%d\t%d\t%ld\t%d\t%zuKb\t\t%02d:%02d:%02d:%03d\t\t%s\n"),
				...
				ppsmemscounters.WorkingSetSize / 1024, 	//Working set size
				creationSystemTime.wHour, creationSystemTime.wMinute, creationSystemTime.wSecond, creationSystemTime.wMilliseconds, //CreationTime
